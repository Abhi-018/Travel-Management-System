...
#================================================Defined Function========================================================================
        ...
        def save_to_text():
                try:
                        filename = "C:\\Users\\jigar\\OneDrive\\Desktop\\travel receipt.txt"
        ...
        # Set the airport tax in Indian Rupees
                ...
                paid1 = AirportTax.get()  # Storing the paid airport tax (assuming AirporTax is a typo and should be AirportTax)
            elif var1.get() == 0:
                self.txtAirportTax.configure(state=DISABLED)
                AirportTax.set(u"\u20B9" + "0")
        ...
        # Set the mileage value
                Mile.set(str(Item2))  # Assuming Mile is a tkinter variable (StringVar, IntVar, etc.)
        ...
        def Lug():
            global Item4
            if var4.get() == 1:
                self.txtLuggage.configure(state=NORMAL)  # Correct the widget name to txtLuggage
        # Assuming the luggage cost is 334.59
                Item4 = 334.59
        # Set the luggage cost with the Indian Rupee symbol
                Luggage.set(u"\u20B9" + str(Item4))
            elif var4.get() == 0:
                self.txtLuggage.configure(state=DISABLED)  # Correct the widget name to txtLuggage
        ...
        # Set the first class fees with the Indian Rupee symbol
                ...
                self.txtFirstClass.configure(state=DISABLED)
                FirstClass.set(u"\u20B9" + "0")  # Set first class fees to 0 when unchecked
    ...
    # Check additional conditions for specific cases
                ...
                if var11.get() == "Heathrow" and var12.get() == "Paris" and var13.get() == "L":
                        special_case = True
                        total_sum += 274.90  # Adjust total sum for the special case
                elif var11.get() == "Assam" and var12.get() == "Assam" and var13.get() == "L":
                        special_case = True
                        total_sum += 365.90  # Adjust total sum for the special case
...
#========================================================================================================================
        ...
        MainFrame.place(relx=0.52, rely=0.5, anchor=CENTER)
        ...
        self.lblTitle.grid()
#=========================================================================================================================
        CustomerDetailsFrame = LabelFrame(MainFrame, width=4000, height=500, bd=20, pady=5, relief=RIDGE)
...
#================================================Receipt========================================================================
        self.txtReceipt = Text(ReceiptFrame , width = 60 , height = 21 ,font=('arial' , 14 , 'bold'))
        self.txtReceipt.grid(row=0,column=0)
      
#================================================Buttons======================================================================
        self.btnTotal = Button(ButtonFrame, padx=18, bd=7, font=('arial', 16,'bold'), width=4, text='Total',command=Total_Paid)
        ...
        self.btnSave = Button(ButtonFrame, padx=18, bd=7, font=('arial', 16,'bold'), width=4, text='Save', command=save_to_text)
